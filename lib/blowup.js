...
$(function ($) {
  $.fn.blowup = function (attributes) {
    ...
    function mouseOverImage(event) {
      ...
      var element_min_x = element.offsetLeft;
      var element_max_x = element_min_x + element.offsetWidth;
      var element_min_y = element.offsetTop;
      var element_max_y = element_min_y + element.offsetHeight;

      if (
        (page_position.x >= element_min_x && page_position.x <= element_max_x) &&
        (page_position.y >= element_min_y && page_position.y <= element_max_y)
      ) {
